...
best_student = Student('Вася', 'Маша', 'your_gender')
bad_student = Student('Петя', 'Настя', 'your_gender')
...
cool_reviewer = Reviewer('Ольга', 'Мария')
bad_reviewer = Reviewer('Никита', 'Миша')
...
bad_reviewer.rate_hw(bad_student, 'C#', 2)
bad_reviewer.rate_hw(bad_student, 'C#', 6)

cool_lecturer = Lecturer('Елена', 'Виктор')
bad_lecturer = Lecturer('Ирина', 'Леонид')
...
best_student.rate_lect(cool_lecturer, 'C#', 9)
best_student.rate_lect(cool_lecturer, 'C#', 9)
best_student.rate_lect(cool_lecturer, 'C#', 9)
...
bad_student.rate_lect(bad_lecturer, 'C#', 1)
bad_student.rate_lect(bad_lecturer, 'C#', 3)
bad_student.rate_lect(bad_lecturer, 'C#', 4)
