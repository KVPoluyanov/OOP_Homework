...
best_student = Student('Kurt', 'Hammel', 'your_gender')
bad_student = Student('Reychal', 'Berry', 'your_gender')
...
cool_reviewer = Reviewer('Samanta', 'Jons')
bad_reviewer = Reviewer('Kerrya', 'Bradshow')
...
cool_lecturer = Lecturer('Tom', 'Ford')
bad_lecturer = Lecturer('Tommy', 'Halfigher')
